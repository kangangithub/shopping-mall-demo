...
public class RedisUtils {
     ...
     * @param jedis
     */
    protected static void returnResource(JedisPool jedisPool, Jedis jedis) {
        if (jedis != null) {
...
//        JedisPool jedisPool = new JedisPool(new GenericObjectPoolConfig(), "116.62.198.241", 6379, 100, "");
